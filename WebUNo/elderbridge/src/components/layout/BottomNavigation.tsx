...
const navItems = [
  { id: "home"   as Page, label: "Home",     icon: Home,          href: "/",        speakAs: "Home screen" },
  { id: "tasks"  as Page, label: "Tasks",    icon: ClipboardList, href: "/tasks",   speakAs: "My saved tasks" },
  { id: "health" as Page, label: "Health",   icon: Heart,         href: "/health",  speakAs: "Health and medicines" },
  { id: "diary"  as Page, label: "Diary",    icon: BookOpen,      href: "/diary",   speakAs: "My digital diary" },
  { id: "help"   as Page, label: "Get Help", icon: Users,         href: "/help",    speakAs: "Get help from family" },
];
